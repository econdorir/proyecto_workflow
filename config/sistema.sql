...
ADD COLUMN anio_inicio INT DEFAULT NULL,
ADD COLUMN anio_fin INT DEFAULT NULL,
ADD COLUMN semestre_inicio VARCHAR(20) DEFAULT NULL,
ADD COLUMN semestre_fin VARCHAR(20) DEFAULT NULL;
