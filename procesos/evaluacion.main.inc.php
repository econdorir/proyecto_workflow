...
$sql = "SELECT a.*, CONCAT(e.nombre, ' ', e.apellido) AS nombre_completo, e.* FROM aplicacion a JOIN estudiante e ON a.estudiante_id = e.id WHERE a.numero_tramite = $numero_tramite";
